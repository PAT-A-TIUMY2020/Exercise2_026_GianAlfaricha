...
namespace Service_026_GianAlfaricha
{
    ...
    {
        [OperationContract]
        [WebGet(UriTemplate = "Mahasiswa", ResponseFormat = WebMessageFormat.Json)] // unruk membuat slash, selalu relative
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_026_GianAlfaricha.ContractType".
